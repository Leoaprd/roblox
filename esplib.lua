...
if not getgenv().SilentHub or getgenv().SilentHub.Aimbot then return end
...
local Environment = getgenv().SilentHub.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().SilentHub.Aimbot.Functions = nil
	getgenv().SilentHub.Aimbot = nil

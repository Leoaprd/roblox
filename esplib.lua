...
if not getgenv().SilentHub or getgenv().SilentHub.WallHack then return end
...
local Environment = getgenv().SilentHub.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().SilentHub.WallHack.Functions = nil
	getgenv().SilentHub.WallHack = nil
